...
| 本棚 | 回の記録 |
|---|---|
| ![本棚。次にやること、自分の担当、新着の件数が並ぶ](docs/images/home.png) | ![回の記録。種類の札、解決済みの疑問、返信スレッド](docs/images/unit.png) |

| 教材の概要 | 検索 |
|---|---|
| ![教材の概要。全体を通しての目標、次にやる回、未解決の疑問の数](docs/images/book.png) | ![検索。ハッシュタグと種類での絞り込み、一致箇所の強調](docs/images/search.png) |
