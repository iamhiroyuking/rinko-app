...
- **課題「全員が理解できているか分からない」への対応が無い。** 理解度の意思表示もメンバーごとの復習回数も不採用となったため、ログへのリアクション機能を入れるかどうかが残っている
- **全員が教材を完全削除した後のデータの扱い。** 誰からもアクセスできなくなった教材とログをどうするか
- **リアルタイム更新の実装方式。** 完全なリアルタイム購読か、画面遷移時の再取得＋新着通知で代替するか
